class PlayDuo extends Phaser.Scene {
    constructor() {
        super("playDuo");
    }
    ...
    create() {
        ...
        //add rockets for both players
        this.p1Rocket = new Rocket(this, game.config.width/3, 431, "rocket", keyLEFT, keyRIGHT, keyUP).setScale(.5,.5).setOrigin(0,0);
        this.p2Rocket = new Rocket(this, 2*game.config.width/3, 431, "rocket", keyS, keyF, keyE).setScale(.5,.5).setOrigin(0,0);
        this.p2Rocket.alpha = .75;
        ...
        this.scoreMid = this.add.text(319, 54, this.p2Score, scoreConfig);
