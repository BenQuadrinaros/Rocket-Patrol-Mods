class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.ship02 = new Spaceship(this, game.config.width + _, _, "spaceship", 0, 30).setOrigin(0,0);
        this.ship03 = new Spaceship(this, game.config.width + _, _, "spaceship", 0, 30).setOrigin(0,0);
